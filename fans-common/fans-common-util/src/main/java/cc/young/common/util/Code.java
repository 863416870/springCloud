...
public enum Code {
    ...
    UN_AUTHORIZATION(21, "Authorization Failed", "认证失败~"),

    UN_AUTHENTICATION(22, "Authentication Failed", "授权失败~"),

    NOT_FOUND(10020, "Not Found", "资源不存在~"),

    PARAMETER_ERROR(10030, "Parameters Error", "参数错误~"),

    PARAMETER_MESSING(10031, "Parameters Missing", "参数丢失~"),
    ...
    FORBIDDEN(10070, "Forbidden", "没有相关权限,禁止操作~"),
    ...
    BUSINESS_ERROR(10200, "Business Error", "业务错误");
